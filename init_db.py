...
slot1 = Time_slot(slotDate = "21stSept", slotTime = "12:30pm")
db.session.add(slot1)
slot2 = Time_slot(slotDate = "21stSept", slotTime = "02:30pm")
db.session.add(slot2)
slot3 = Time_slot(slotDate = "21stSept", slotTime = "04:30pm")
db.session.add(slot3)
slot4 = Time_slot(slotDate = "21stSept", slotTime = "06:00pm")
db.session.add(slot4)
slot5 = Time_slot(slotDate = "22stSept", slotTime = "01:30pm")
db.session.add(slot5)
slot6 = Time_slot(slotDate = "22stSept", slotTime = "03:30pm")
db.session.add(slot6)
slot7 = Time_slot(slotDate = "22stSept", slotTime = "04:30pm")
db.session.add(slot7)
slot8 = Time_slot(slotDate = "22stSept", slotTime = "07:30pm")
